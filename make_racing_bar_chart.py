...
Data:
    ...
    Captions:
        Image: (None)
        From :: To :: Caption:
        <import Captions CSV generated by this script>
        <see FLOURISH_CAPTIONS_CSV_NAME>

Preview:
    Bars:
        No. bars: 20
        Bar Height: Specified ## This lets you have a taller and larger graphic
        Height: 2
    Bar colors:
...
Legacy FFA: #cb4b1699    
Legacy 2TDM: #268bd299    
Legacy 4TDM: #85990099    
Legacy Open TDM: #2aa19899    
Legacy Maze: #b5890099    
Legacy Maze 4TDM: #d3368299    
Legacy Portal 4TDM: #93a1a199    
Legacy Domination: #586e7599    
Legacy Squads-Duos: #6c71c499 
...
# A note on the tank images, they don't show up when you download the records sheet as a csv, so instead I just hardcoded them all
# I obtained the image url's with a bunch of spreadsheet formulas, the process was essentially this:
    # Make a new sheet, and copy the tank images column and tank names column from Records over to the new sheet
    # Process Tank Image URL's
        # Get the raw formulas from the tank images column with =FORMULATEXT
        # Use =SUBSTITUTE a few times to remove "=image(", "=Image(", "=IMAGE(", and ")"
        # You should be left with a column of the raw tank image url's surrounded by ""
    # Process Tank Names
        # Use =FILTER with conditions =NOT(ISBLANK()) and =NOT(REGEXMATCH("TIER")) to remove the blank space cells and the Tier 1/2/3 cells
    # Match the tank names with their image url's using a =VLOOKUP
        # Make sure to specify is_sorted=FALSE or otherwise you'll get wrong matches
        # Like Overlord image for Overseer, and Auto3 image for AutoOverseer & Auto5
        # And Basic image for Artillery, and Swarmer image for trap guard
    # Use formulas to make a new column whose cells are basically just JSON and can be copy&pasted directly into a python file
        # Use the & operator to concat text and use """" to make a double quote (repeating the " escapes it)
        # Here's an example of mine: =ARRAYFORMULA("""" & AT5:AT & """" & ": " & AU5 & ",")
            # One row this makes is: 
            # "(Basic) Tank": "https://i.imgur.com/rZLa1ha.png",
# Add new tank images to the hardcoded dict
TANK_IMAGES = {
    "(Basic) Tank": "https://i.imgur.com/rZLa1ha.png",
    "Director": "https://i.imgur.com/VGhbXmI.png",
    "Flank Guard": "https://i.imgur.com/kwWl4lc.png",
    "Machine Gun": "https://i.imgur.com/PNPNN7i.png",
    "Pounder": "https://i.imgur.com/pNNCowj.png",
    "Sniper": "https://i.imgur.com/H1jbB2E.png",
    "Trapper": "https://i.imgur.com/bQyEt1Y.png",
    "Twin": "https://i.imgur.com/1gBELOb.png",
    "Artillery": "https://i.imgur.com/FvAmRJw.png",
    "Assassin": "https://i.imgur.com/q8uHNw1.png",
    "Auto 3": "https://i.imgur.com/WOyL7qb.png",
    "Builder": "https://i.imgur.com/Nncbq0b.png",
    "Cruiser": "https://i.imgur.com/ThmR74d.png",
    "Destroyer": "https://i.imgur.com/xxoYDht.png",
    "Double Twin": "https://i.imgur.com/Kow7uit.png",
    "Gunner": "https://i.imgur.com/IBki2CC.png",
    "Hexa Tank": "https://i.imgur.com/kYMaDLr.png",
    "Hunter": "https://i.imgur.com/iy3brDg.png",
    "Launcher": "https://i.imgur.com/oFiyWkL.png",
    "Minigun": "https://i.imgur.com/VTyWhqu.png",
    "Overseer": "https://i.imgur.com/4PlspLD.png",
    "Rifle": "https://i.imgur.com/kMS7pj0.png",
    "Smasher": "https://i.imgur.com/Tm1g5oc.png",
    "Spawner": "https://i.imgur.com/IvsRWyT.png",
    "Trap Guard": "https://i.imgur.com/JUeXtFa.png",
    "Tri-Angle": "https://i.imgur.com/zrn77tC.png",
    "Triple Shot": "https://i.imgur.com/l5kAdPE.png",
    "Tri-Trapper": "https://i.imgur.com/1KaGISp.png",
    "Underseer": "https://i.imgur.com/E8zyjKh.png",
    "Annihilator": "https://i.imgur.com/9Dt5Zuz.png",
    "Architect": "https://i.imgur.com/LUGYClS.png",
    "Armsman": "https://i.imgur.com/43zPhsD.png",
    "Auto-4": "https://i.imgur.com/UQgKGbH.png",
    "Auto-5": "https://i.imgur.com/P1c0yP0.png",
    "Auto Assassin": "https://i.imgur.com/mUw6xWY.png",
    "Auto Builder": "https://i.imgur.com/zZaKxUs.png",
    "Auto Cruiser": "https://i.imgur.com/Lo75Ni6.png",
    "Auto Double": "https://i.imgur.com/SPEm82u.png",
    "Auto Gunner": "https://i.imgur.com/x3tTlYc.png",
    "Auto Overseer": "https://i.imgur.com/XJ3QKyD.png",
    "Auto Smasher": "https://i.imgur.com/G4ftCaf.png",
    "Auto Spawner": "https://i.imgur.com/7eiAODo.png",
    "Auto Tri-Angle": "https://i.imgur.com/5qsdFjN.png",
    "Banshee": "https://i.imgur.com/XVwDJpX.png",
    "Barricade": "https://i.imgur.com/AGirgU0.png",
    "Battleship": "https://i.imgur.com/aTqo2w1.png",
    "Beekeeper": "https://i.imgur.com/kKvY1ei.png",
    "Bent Double": "https://i.imgur.com/DvDThgL.png",
    "Bent Hybrid": "https://i.imgur.com/Qop4WJ0.png",
    "Bomber": "https://i.imgur.com/1w7Ydel.png",
    "Boomer": "https://i.imgur.com/t11naZA.png",
    "Booster": "https://i.imgur.com/FIHdZXS.png",
    "Bulwark": "https://i.imgur.com/keHtkhi.png",
    "Bushwhacker": "https://i.imgur.com/g2cU3sB.png",
    "Carrier": "https://i.imgur.com/r3zMBhM.png",
    "Commander": "https://cdn.discordapp.com/attachments/688618660499423344/794327030200008756/Commander-Blue.png",
    "Conqueror": "https://i.imgur.com/Eiivgtf.png",
    "Constructor": "https://i.imgur.com/pdQTvuh.png",
    "Crop Duster": "https://i.imgur.com/yJu1Tkt.png",
    "Crossbow": "https://i.imgur.com/GBfpiKw.png",
    "Cyclone": "https://i.imgur.com/AaZkkOq.png",
    "Dual": "https://i.imgur.com/7E6ZO9p.png",
    "Eagle": "https://i.imgur.com/fbH0Cla.png",
    "Engineer": "https://i.imgur.com/gX4zd9T.png",
    "Factory": "https://i.imgur.com/pQCEWh6.png",
    "Falcon": "https://i.imgur.com/ksDVwyC.png",
    "Fighter": "https://i.imgur.com/UZTDqVO.png",
    "Fortress": "https://i.imgur.com/ZQE3WuB.png",
    "Gunner Trapper": "https://i.imgur.com/Pm3VgV5.png",
    "Hexa Trapper": "https://i.imgur.com/xTTZpM6.png",
    "Hewn Double": "https://i.imgur.com/rmGwz2D.png",
    "Hybrid": "https://i.imgur.com/HuKqWG7.png",
    "Landmine": "https://i.imgur.com/QFKARXA.png",
    "Machine Gunner": "https://i.imgur.com/VG1Vv3C.png",
    "Maleficitor": "https://i.imgur.com/Bw22bDg.png",
    "Manager": "https://i.imgur.com/WwpjRyV.png",
    "Mega Smasher": "https://i.imgur.com/O37PHBt.png",
    "Mega-3": "https://i.imgur.com/xXPGXBl.png",
    "Mortar": "https://i.imgur.com/0jQveKh.png",
    "Musket": "https://i.imgur.com/EmAaI9D.png",
    "Nailgun": "https://i.imgur.com/om5xC1b.png",
    "Necromancer": "https://i.imgur.com/o4c5Y2T.png",
    "Octo Tank": "https://i.imgur.com/9Usar8P.png",
    "Ordnance": "https://i.imgur.com/X7iklpt.png",
    "Overdrive": "https://i.imgur.com/YZKzW1G.png",
    "Overgunner": "https://i.imgur.com/G9U9Xhm.png",
    "Overlord": "https://i.imgur.com/r9AIKn0.png",
    "Overtrapper": "https://i.imgur.com/2saGSa6.png",
    "Penta Shot": "https://i.imgur.com/PhlPIrU.png",
    "Poacher": "https://i.imgur.com/MMb2b7m.png",
    "Predator": "https://i.imgur.com/QkHSQuh.png",
    "Ranger": "https://i.imgur.com/v6bGOg0.png",
    "Septa Trapper": "https://i.imgur.com/sEYq3CS.png",
    "Shotgun": "https://i.imgur.com/Jf2wNPI.png",
    "Sidewinder": "https://i.imgur.com/vAhBQTW.png",
    "Single": "https://i.imgur.com/O3WuaMn.png",
    "Skimmer": "https://i.imgur.com/FGyHmQF.png",
    "Spike": "https://i.imgur.com/WieGyzq.png",
    "Sprayer": "https://i.imgur.com/RVCV8ue.png",
    "Spreadshot": "https://i.imgur.com/4UsuTt6.png",
    "Stalker": "https://i.imgur.com/pYaKLwb.png",
    "Streamliner": "https://i.imgur.com/s9FknJV.png",
    "Surfer": "https://i.imgur.com/7yBh1KJ.png",
    "Swarmer": "https://i.imgur.com/6PNnKNm.png",
    "Triple Twin": "https://i.imgur.com/AjQRwCX.png",
    "Triplet": "https://i.imgur.com/v29Ylny.png",
    "Twister": "https://i.imgur.com/08hhR7k.png"
}
...
def makeFlourishCsvFiles(scoresWithDates):
    ...
    tanksWithMissingImageURLs = set()

    with open(GENERATED_FILES_FOLDER_NAME + "/" + FLOURISH_DATA_CSV_NAME, "w") as flourishDataFile:
        writer = csv.writer(flourishDataFile)

        # header row
        writer.writerow(["Description", "Description & Legacy Status", "Gamemode",  "Gamemode & Legacy Status", "Tank Image URL", *formatted_dates])
        ...
        for score in scoresWithDates:
            ...
            if tank in TANK_IMAGES:
                tankImageURL = TANK_IMAGES[tank]
            # Some tanks are spelled both with and without a dash in some records
            # Auto Spawner and Auto Assassin
            elif tank.replace("-", " ") in TANK_IMAGES:
                tankImageURL = TANK_IMAGES[ tank.replace("-", " ") ]
            else:
                tanksWithMissingImageURLs.add(tank)
                tankImageURL = ""

            new_csv_row = [description, descriptionAndLegacyStatus, gamemode, gamemodeAndLegacyStatus, tankImageURL]
    ...
    # print tanks with missing image url's to the terminal
    for tank in tanksWithMissingImageURLs:
        print(f"{tank} does not have a matching url in the TANK_IMAGES dict!")
